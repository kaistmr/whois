...
2. 스프레드시트의 정보가 GAS를 거쳐 자동으로 웹용 CSV로 변환됩니다. (`Web` 시트)
...
- 만약 스프레드 시트의 링크가 바뀌었다면, MR 구글 드라이브의 Google App Scripts 파일 "Login_auth_server"의 설정에서 SECRET_SHEET_ID를 수정한 뒤, 해당 GAS를 새로 배포하여 배포URL을 깃허브의 config.js에서 바꿔주세요.
